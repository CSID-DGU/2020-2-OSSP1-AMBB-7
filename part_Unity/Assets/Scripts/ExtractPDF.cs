...
public class ExtractPDF : MonoBehaviour {
	...
	void Start ()
	{
		itemsEng.Add("Front View"); // ���鵵
		itemsEng.Add("Left Side View"); // �����鵵
		itemsEng.Add("Right Side View"); //�����鵵
		itemsEng.Add("Floor Plan");// ��鵵
		itemsEng.Add("Rear View"); // ��鵵
		itemsEng.Add("Bottom View"); // ���鵵;
